  ...
  return (
    ...
    <div className="container mx-auto p-4">
      <form onSubmit={updateData}>
       ...
       <div class="md:max-w-screen-xl xl:max-w-screen-2xl flex flex-wrap items-center justify-between p-4">
       <Link to="/">
       ...
       <main  className="mb-auto h-10  p-4">
          ...
          <div className="border-b my-5">
            ...
            id=""
            cols="100"
            rows="10" // Ubah ini menjadi jumlah baris awal yang lebih rendah
            value={description}
            placeholder="Description"
            onChange={(e) => setDescription(e.target.value)}
            className="w-full h-auto px-4 py-2  resize-none rounded-md"
          />
