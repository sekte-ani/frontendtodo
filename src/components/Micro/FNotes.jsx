    ...
    <div className="flex flex-col h-screen justify-between">
          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0  d">
              {/* <li className="mt-1">
                ...
                /> */}
              <li>
                <BsTrash className="mt-2" size={25} />
              </li>
              <li>
                <button
                  type="button"
          ...
          <div className="border-b my-5">
            <div className="App">
              <ReactQuill
                ...
                modules={FNotes.modules}
                formats={FNotes.formats}
                onChange={handleBody}
                value={body}
              />
            </div>
      ...
      <footer class="h-12 bg-blue-500  py-2 flex justify-center ">
        <ul class="font-medium text-lg text-white flex flex-col p-4 md:p-0 mt-4 border  border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0  d">
          ...
          <li>Body</li>
          <li>
            <RiListUnordered size={30} color="white" />
          </li>
          <li>
            <RiListOrdered size={30} color="white" />
          </li>
          <li>
            <BsListCheck size={30} color="white" />
          </li>
          <li>
            <BiBold size={30} color="white" />
          </li>
          <li>
            <BsTypeItalic size={30} color="white" />
          </li>
          <li>
            <BsTypeUnderline size={30} color="white" />
          </li>
          <li>
            <BsTypeStrikethrough size={30} color="white" />
          </li>
          <li>
            <BsPencilFill size={23} color="white" />
          </li>
        </ul>
      </footer>
    </div>
