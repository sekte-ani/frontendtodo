          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8 ">
            <form class="space-y-4 md:space-y-6" action="#">
              ...
              <div class="flex items-center justify-between">
                <a class="text-sm font-medium text-primary-600  text-gray-300">
                  Forgot password?
                  <label className="text-blue-500 underline hover:text-md">
                    Click here
                  </label>
                </a>
              </div>
              <div className="flex-1 text-right ">
                ...
                <p class="text-sm font-light text-gray-300 dark:text-gray-300 mt-2">
